...
OWNED_SOURCES = [
    "src/api/curlparse_api.c",
    "src/api/curlparse_core.c",
    "src/api/curlparse_json.c",
    "src/api/curlparse_result.c",
    "src/api/curlparse_stubs.c",
    "src/runtime/curlparse_profile.c",
    "src/runtime/curlparse_libinfo.c",
    "src/runtime/curlparse_option_guard.c",
    "src/capture/curlparse_event_scan.c",
    "src/capture/curlparse_serialize_config.c",
    "src/io/curlparse_virtual_files.c",
]
